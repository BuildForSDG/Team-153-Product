...
@section('content')
    ...
    <header class="masthead">
        <div class="container">
            ...
            <a class="btn btn-success btn-xl text-uppercase js-scroll-trigger mr-4" href="{{route('donate')}}">Donate</a>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{route('aids')}}">Apply</a>
        </div>
    </header>
    <!-- Services-->
    <section class="page-section" id="services">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Click one one of the categories to view the availabe list of donations</h3>
            </div>
